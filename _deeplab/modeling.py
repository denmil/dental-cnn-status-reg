...
def deeplabv3_hrnetv2_48(num_classes=21, output_stride=4, pretrained_backbone=False): # no pretrained backbone yet
    return _load_model(arch_type='deeplabv3', backbone='hrnetv2_48',
                       output_stride=output_stride, num_classes=num_classes, pretrained_backbone=pretrained_backbone)

def deeplabv3_hrnetv2_32(num_classes=21, output_stride=4, pretrained_backbone=True):
    return _load_model(arch_type='deeplabv3', backbone='hrnetv2_32',
                       output_stride=output_stride, num_classes=num_classes, pretrained_backbone=pretrained_backbone)
